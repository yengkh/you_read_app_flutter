                      ...
                      child: Column(
                        ...
                        children: [
                          ReadPageItem(
                            ...
                            title: "Add book to favorite",
                            snackBarTitle: "Book added to Favorite!",
                            onTapEvent: () async {
                              ...
                              if (widget.sqlModel == null) {
                                await FavoriteDatabaseHelper.addToFavorite(data);
                              } else {
                                await FavoriteDatabaseHelper.updateFavorite(data);
                              }
                            },
                          ),
                          ReadPageItem(
